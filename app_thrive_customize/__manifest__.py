...
{
    'name': 'thrive Tweak,Ai Employee,Boost,Customize All in One. Customize,UI,Boost,Security,Data,Development Enhance',
    'version': '23.11.16',
    'author': 'odooai.cn',
    ...
    'summary': """
    Ai as employee. 1 click Tweak thrive. 48 Functions thrive enhancement. for Customize, UI, Boost, Security, Development.
