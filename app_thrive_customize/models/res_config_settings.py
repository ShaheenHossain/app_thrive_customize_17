...
class ResConfigSettings(models.TransientModel):
    ...
    app_stop_subscribe = fields.Boolean('Stop Odoo Subscribe', help="Check to stop subscribe and follow. This to make thrive speed up.",
                                        config_parameter='app_stop_subscribe')
    # 处理额外模块
    module_app_odoo_doc = fields.Boolean("Help Document Anywhere", help='Get Help Documentation on current thrive operation or topic.')
